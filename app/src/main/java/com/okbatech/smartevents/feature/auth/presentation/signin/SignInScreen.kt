    ...
    Scaffold { padding ->
        Column(
            ...
            Row(
                ...
                SocialCircle(label = "G", background = Color.White, textColor = Color(0xFFEA4335))
...
@Composable
private fun SocialCircle(label: String, background: Color, textColor: Color = Color.White) {
    Box(
        modifier = Modifier
            .size(52.dp)
